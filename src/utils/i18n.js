...
const translations = {
  'zh-cn': {
    ...
    imageHostDescription:
      '选择图片处理方式。本地测试使用Base64编码，无需网络连接。FreeImage.host通过代理上传，需API密钥。',
  ...
  en: {
    ...
    imageHostDescription:
      'Choose image processing method. Local test uses Base64 encoding, no network connection required. FreeImage.host uploads via proxy, requires API key.',
